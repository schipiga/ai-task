...
class Metric(db.Model):
    ...
    sum_of_toxic = db.Column(db.Float)
    sum_of_severe_toxic = db.Column(db.Float)
    sum_of_obscene = db.Column(db.Float)
    sum_of_threat = db.Column(db.Float)
    sum_of_insult = db.Column(db.Float)
    sum_of_identity_hate = db.Column(db.Float)
